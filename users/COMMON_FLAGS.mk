...
ifeq ($(CONFIG_SET_PHY_PORT_POWER_DOWN),y)
COMMON_CFLAGS += -DCONFIG_SET_PHY_PORT_POWER_DOWN
endif
...
ifeq ($(CONFIG_CMCC),y)
COMMON_CFLAGS += -DCONFIG_CMCC
ifeq ($(CONFIG_RTL_8197F_GW),y)
COMMON_CFLAGS += -DCONFIG_RTL_8197F_GW
else
ifeq ($(CONFIG_RTL_8197F_AP),y)
COMMON_CFLAGS += -DCONFIG_RTL_8197F_AP
else
ifeq ($(CONFIG_RTL_8197F_RPT),y)
COMMON_CFLAGS += -DCONFIG_RTL_8197F_RPT
endif
endif
endif
endif
...
ifeq ($(CONFIG_RECORD_CLIENT_HOST),y)
COMMON_CFLAGS += -DCONFIG_RECORD_CLIENT_HOST
endif
...
ifeq ($(CONFIG_SUPPORT_WINNUKE_ICMP_REDIRECTION), y)
COMMON_CFLAGS += -DSUPPORT_WINNUKE_ICMP_REDIRECTION
endif
...
COMMON_CFLAGS += -DCONFIG_ELINK_SUPPORT
endif

ifeq ($(CONFIG_ANDLINK_SUPPORT), y)
COMMON_CFLAGS += -DCONFIG_ANDLINK_SUPPORT
ifeq ($(CONFIG_ANDLINK_IF5_SUPPORT),y)
COMMON_CFLAGS += -DCONFIG_ANDLINK_IF5_SUPPORT
endif
endif
...
COMMON_CFLAGS += -DTIMER_TASK_SUPPORT

ifeq ($(CONFIG_APP_GNU_WGET), y)
COMMON_CFLAGS += -DCONFIG_WGET_SUPPORT
endif

ifeq ($(CONFIG_APP_SDK_ONENET), y)
COMMON_CFLAGS += -DCONFIG_APP_SDK_ONENET
endif

ifeq ($(CONFIG_APP_CMCC_ADAPTER), y)
COMMON_CFLAGS += -DCONFIG_APP_CMCC_ADAPTER
endif

ifeq ($(CONFIG_CMCC_DM), y)
COMMON_CFLAGS += -DCONFIG_CMCC_DM
endif

ifeq ($(CONFIG_ONLINE_UPDATE), y)
COMMON_CFLAGS += -DCONFIG_ONLINE_UPDATE
endif

ifeq ($(CONFIG_STATIC_IP),y)
COMMON_CFLAGS += -DCONFIG_STATIC_IP
endif
...
COMMON_CFLAGS += -DCONFIG_APP_BOA_HE_UI
endif
ifeq ($(CONFIG_APP_BOA_NEW_UI),y)
COMMON_CFLAGS += -DCONFIG_APP_BOA_NEW_UI
endif
ifeq ($(CONFIG_APP_CMCC_GW_UI),y)
COMMON_CFLAGS += -DCONFIG_APP_CMCC_GW_UI
endif
...
ifeq ($(CONFIG_APP_ARPTABLES),y)
COMMON_CFLAGS += -DCONFIG_APP_ARPTABLES
endif
...
COMMON_CFLAGS += -DCONFIG_MODEL_HN330_331EA
endif

ifeq ($(CONFIG_MODEL_HN350_339EA),y)
COMMON_CFLAGS += -DCONFIG_MODEL_HN350_339EA
endif

ifeq ($(CONFIG_MODEL_HN100_340EA),y)
COMMON_CFLAGS += -DCONFIG_MODEL_HN100_340EA
endif

ifeq ($(CONFIG_MODEL_HN120_341FA),y)
COMMON_CFLAGS += -DCONFIG_MODEL_HN120_341FA
endif

ifeq ($(CONFIG_MODEL_HN120_341BA),y)
COMMON_CFLAGS += -DCONFIG_MODEL_HN120_341BA
endif

ifeq ($(CONFIG_MODEL_HN140_361EA),y)
COMMON_CFLAGS += -DCONFIG_MODEL_HN140_361EA
endif

COMMON_CFLAGS += -DREINIT_WAN_SUPPORT
