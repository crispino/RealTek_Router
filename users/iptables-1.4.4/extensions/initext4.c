...
extern void libxt_phyport_init(void);
...
extern void libxt_TCPMSS_init(void);
extern void libxt_TCPOPTADD_init(void);
...
extern void libipt_set_init(void);
extern void libipt_SET_init(void);
...
extern void libipt_vlanid_init(void);
extern void libipt_vlanpriority_init(void);
extern void libipt_vlanpriorityt_init(void);
...
void init_extensions(void)
{
 ...
 libipt_unclean_init();
 libipt_vlanid_init();
 libipt_vlanpriority_init();
 libipt_vlanpriorityt_init();
}
