cmd_scripts/basic/split-include := gcc -Wp,-MD,scripts/basic/.split-include.d  -Wall -Wstrict-prototypes -Os -fomit-frame-pointer       -o scripts/basic/split-include scripts/basic/split-include.c  
