cmd_scripts/basic/docproc := gcc -Wp,-MD,scripts/basic/.docproc.d  -Wall -Wstrict-prototypes -Os -fomit-frame-pointer       -o scripts/basic/docproc scripts/basic/docproc.c  
