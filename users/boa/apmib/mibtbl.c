...
#ifdef SBWC
mib_table_entry_T mib_wlan_sbwc_tbl[]={
#ifdef MIB_TLV
#define MIBDEF(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl, decision_id, reinit_id ) \
	{_MIBID_NAME(_mib_name), _mib_type, _OFFSET_SIZE_FIELD(_mib_parents_ctype, _cname), _UNIT_SIZE(_ctype), _default_value, _next_tbl, _REINIT_FIELD(decision_id,reinit_id)},
#else
...
#define MIB_WLAN_SBWC_ENTRY
#include "mibdef.h"
#undef MIB_WLAN_SBWC_ENTRY
...
mib_table_entry_T mib_timer_task_tbl[]={
#ifdef MIB_TLV
#define MIBDEF(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl, decision_id, reinit_id ) \
	{_MIBID_NAME(_mib_name), _mib_type, _OFFSET_SIZE_FIELD(_mib_parents_ctype, _cname), _UNIT_SIZE(_ctype), _default_value, _next_tbl, _REINIT_FIELD(decision_id,reinit_id)},
#else
...
#define MIB_TIMER_TASK_ENTRY
#include "mibdef.h"
#undef MIB_TIMER_TASK_ENTRY
...
mib_table_entry_T mib_rtl_link_area_tbl[]={
#ifdef MIB_TLV
#define MIBDEF(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl, decision_id, reinit_id ) \
	{_MIBID_NAME(_mib_name), _mib_type, _OFFSET_SIZE_FIELD(_mib_parents_ctype, _cname), _UNIT_SIZE(_ctype), _default_value, _next_tbl, _REINIT_FIELD(decision_id,reinit_id)},
#else
...
#define MIB_RTL_LINK_AREA_ENTRY
#include "mibdef.h"
#undef MIB_RTL_LINK_AREA_ENTRY
