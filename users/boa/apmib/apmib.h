...
//============calc cpu occupy==========
#define CALC_CPU_OCCUPY
#ifdef CALC_CPU_OCCUPY
#define CPU_OCCUPY_FILE 	"/var/tmp/cpu_occupy"
#endif
...
//#endif
	...
	#endif
#endif
#if defined(VOIP_SUPPORT) || defined(CONFIG_APP_TR069) || defined(FAST_BSS_TRANSITION) || defined(RTK_CAPWAP) || defined(SBWC) || defined(TIMER_TASK_SUPPORT) || defined(CONFIG_ANDLINK_SUPPORT)
...
#define MIB_MACFILTER_TBL_NUM		123    //wirte table
...
#define MIB_NTP_SYNC_INTERVAL			2251
#endif
...
#ifdef CONFIG_CMCC
#define MIB_CUSTOMER_HW_WLAN0_SSID	CUSTOMER_HW_MIB_BaseId+2
#define MIB_CUSTOMER_HW_WLAN1_SSID	CUSTOMER_HW_MIB_BaseId+3
#define MIB_CUSTOMER_HW_WLAN0_WPA_PSK CUSTOMER_HW_MIB_BaseId+4
#define MIB_CUSTOMER_HW_WLAN1_WPA_PSK CUSTOMER_HW_MIB_BaseId+5
#define MIB_CUSTOMER_HW_ADMIN_PASSWORD CUSTOMER_HW_MIB_BaseId+7
#define MIB_CUSTOMER_HW_TELNETD_DISABLE CUSTOMER_HW_MIB_BaseId+8
#define MIB_CUSTOMER_HW_CGW_IP_ADDR CUSTOMER_HW_MIB_BaseId+9
#define MIB_CUSTOMER_HW_OP_MODE CUSTOMER_HW_MIB_BaseId+10
#define MIB_CUSTOMER_HW_LAN_IP CUSTOMER_HW_MIB_BaseId+11
#define MIB_CUSTOMER_HW_DOMAIN_NAME CUSTOMER_HW_MIB_BaseId+12
#endif
#ifdef CONFIG_CMCC_DM
#define MIB_CUSTOMER_HW_CMEI CUSTOMER_HW_MIB_BaseId+6
#endif
#ifdef CONFIG_ONLINE_UPDATE
#define MIB_CUSTOMER_HW_SER_ADDR CUSTOMER_HW_MIB_BaseId+13
#endif
#define MIB_PROVINCIAL_CODE	CUSTOMER_HW_MIB_BaseId+14
#define MIB_CUSTOMER_HW_PROVINCIAL_CODE	CUSTOMER_HW_MIB_BaseId+15
#endif
...
#define MIB_URLFILTER_MODE		255
#define IP_RANGE_CMCC_SUPPORT
#if defined(IP_RANGE_CMCC_SUPPORT)
#define MIB_IPFILTER_MODE       257 //white list or black list
#define MIB_IPFILTER_TYPE       258 //ip based or proto based
#endif
#define MIB_MACFILTER_MODE		259
...
#define MIB_IGMP_SNOOPING_DISABLE 463
#define MIB_MLD_SNOOPING_DISABLE 464

#define RTL_NF_ALG_CTL 1
#ifdef RTL_NF_ALG_CTL
#define MIB_ALG_FTP_DISABLE 455
#define MIB_ALG_TFTP_DISABLE 456
#define MIB_ALG_RTSP_DISABLE 457
#define MIB_ALG_PPTP_DISABLE 458
#define MIB_ALG_L2TP_DISABLE 459
#define MIB_ALG_IPSEC_DISABLE 460
#define MIB_ALG_SIP_DISABLE 461
#define MIB_ALG_H323_DISABLE 462
#endif
/* # keith: add l2tp support. 20080515 */
#ifdef CONFIG_GET_SERVER_IP_BY_DOMAIN
...
#ifdef CONFIG_APP_BOA_HE_UI
#define MIB_NEED_NO_WIZARD 622
#define MIB_SITE_ACCESS 623
#define MIB_NEED_UPDATE 624
#define MIB_UPDATE_TIME 625
#define MIB_UPDATE_URL 626
#endif
...
#define MIB_IPFILTER_DSTIPADDR      1037
#define MIB_IPFILTER_DSTIPADDR_END  1038
#define MIB_IPFILTER_TYPE_ID    1039
#define MIB_IPFILTER_MODE_ID    1040
#endif
...
#define MIB_MACFILTER_TYPE		1053
...
#define MIB_RTL_LINK_ENABLE                1410
#define MIB_RTL_LINK_VENDOR                1411
#define MIB_RTL_LINK_DEVMODEL              1412
#define MIB_RTL_LINK_SWVERSION             1413
#define MIB_RTL_LINK_HWVERSION             1414
#define MIB_RTL_LINK_URL                   1415
#define MIB_RTL_LINK_WIRELESS              1416
#define MIB_RTL_LINK_SYNCCODE              1417
#define MIB_RTL_LINK_SN                    1418
#define MIB_WLAN_STA_NUM                   1419
#define MIB_WLAN_RSSI_TH                   1420

#define MIB_RTL_LINK_RECOVER_MAP            1421
#define MIB_RTL_LINK_OPMODE_BACKUP          1422
#define MIB_RTL_LINK_DHCP_BACKUP            1423
#define MIB_RTL_LINK_REPEATER1_BACKUP       1424
#define MIB_RTL_LINK_REPEATER2_BACKUP       1425
#define MIB_RTL_LINK_MODE1_BACKUP           1426
#define MIB_RTL_LINK_MODE2_BACKUP           1427
#define MIB_RTL_LINK_NEED_RECOVERY          1428
#define MIB_RTL_LINK_CONNECT_GW_TIMEOUT     1429
#define MIB_RTL_LINK_GETIP_TIMEOUT          1430
#define MIB_RTL_LINK_ROAMING_RSSI_GAP       1431
#define MIB_RTL_LINK_ROAMING_TIME_GAP       1432
#define MIB_RTL_LINK_GW_IP_ADDR             1433

#define MIB_RTL_LINK_DEVTYPE                1434
#define MIB_RTL_LINK_PRODTOKEN              1435
#define MIB_RTL_LINK_DEVID                  1436
#define MIB_RTL_LINK_DEVTOKEN               1437
#define MIB_RTL_LINK_ANDLINKTOKEN           1438
#define MIB_RTL_LINK_HBTIME                 1439
#define MIB_RTL_LINK_SEARCH_GW_MAX_RETRY    1440
#define MIB_RTL_LINK_MODE                   1441
#define MIB_RTL_LINK_LOCAL_IP_ADDR          1442
//for andlink v2.10e
#define MIB_RTL_LINK_GWTOKEN                1800
#define MIB_RTL_LINK_ANDLINK_VER            1801
#define MIB_RTL_LINK_SEARCH_ACK             1802    //ANDLINK2.10e handle andlink searchack after searchgw sync
#define MIB_RTL_LINK_SEARCH_ASYNC           1803    //ANDLINK2.10e searchgw async
//for andlink v2.10f
#define MIB_RTL_LINK_HBPORT                 1804
//for andlink roaming
#define MIB_RTL_LINK_ROAMING_SWITCH         1805
#define MIB_RTL_LINK_ROAMING_QOS            1806
#define MIB_RTL_LINK_ROAMING_RETRY_RATIO    1807
#define MIB_RTL_LINK_ROAMING_FAIL_RATIO     1808
#define MIB_RTL_LINK_ROAMING_DETEC_PERIOD   1809
#define MIB_RTL_LINK_ROAMING_RSSI_DELTA     1810
#define MIB_RTL_LINK_ROAMING_DISMISS_TIME   1811
#define MIB_RTL_LINK_ROAMING_LOWQUALITY_TIME    1812
#define MIB_RTL_LINK_ROAMING_NEIGHBOR_TIME  1813
#define MIB_RTL_LINK_ROAMING_RATE_TH        1814
#define MIB_RTL_LINK_ROAMING_DEBUG_ON       1815
#define MIB_RTL_LINK_REPEATER_MODE_BACKUP   1816

#define MIB_RTL_LINK_FW_UPGRADE             1817
#define MIB_RTL_LINK_AUTO_DHCP              1818
//for andlink v3.0b
#define MIB_RTL_LINK_USER_KEY               1819
#define MIB_RTL_LINK_CGW_IP_ADDR            1820
#define MIB_RTL_LINK_CGWTOKEN               1821

#define MIB_RTL_LINK_FW_DOWNLOAD_SUCCESS    1822
#define MIB_RTL_LINK_CGW_UDPPORT            1823
#define MIB_RTL_LINK_CGW_TCPPORT            1824
#define MIB_RTL_LINK_CGW_MS_IP_ADDR         1825
#define MIB_RTL_LINK_CGW_PORT_CLOUD			1826  //for andlink_if5, added by elaine
//#define MIB_RTL_LINK_V25_SUPPORT            1826
#define MIB_RTL_LINK_V25_MACAC_POLICY		1827
/*******for andlink_if5, added by elaine***********/
#define MIB_RTL_LINK_CGW_IP_ADDR_IF5		1828
#define MIB_RTL_LINK_CGW_PORT_IF5			1829
#define MIB_RTL_LINK_CGWTOKEN_IF5			1830
#define MIB_RTL_LINK_CGW_MQTT_USER	        1831 
#define MIB_RTL_LINK_CGW_MQTT_CLIENTID      1832 
//#define MIB_RTL_LINK_CGW_MQTT_URL           1833 
#define MIB_RTL_LINK_CGW_MQTT_IP_ADDR       1833
#define MIB_RTL_LINK_CGW_MQTT_PORT          1834
#define MIB_RTL_LINK_CGW_MQTT_PASSWORD      1835
#define MIB_RTL_LINK_CGW_MQTT_KEEPALIVE     1836
#define MIB_RTL_LINK_CGW_AUTOBOOT_URL       1837
#define MIB_RTL_LINK_CGW_AUTOBOOT_FLAG      1838
#define MIB_RTL_LINK_CGW_AUTOBOOT_DEFAULT_USERKEY    1839
/********************************************/
#define MIB_RTL_LINK_AREA               1840
#endif
#ifdef CONFIG_APP_CMCC_ADAPTER
#define MIB_UPGRADED_FW 				1444
#define MIB_WAN_CONFIGURED              1445
#define MIB_DEVICE_PASSWORD				1446
#endif
#ifdef DEFAULT_SETTING_CHECK
#define MIB_IS_DEFAULT_SETTING			1448
#endif
/*for P2P_SUPPORT*/
...
#ifdef SBWC
#define WLAN_SBWC_ID                          2620
#define MIB_SBWC_ENABLE                (WLAN_SBWC_ID+0)
#define MIB_SBWC_NUM                    (WLAN_SBWC_ID+1)
#define MIB_SBWC_TBL                    ((WLAN_SBWC_ID+2)|MIB_TABLE_LIST)
#define MIB_SBWC_ADD                    ((WLAN_SBWC_ID+3)|MIB_ADD_TBL_ENTRY)
#define MIB_SBWC_DEL                    ((WLAN_SBWC_ID+4)|MIB_DEL_TBL_ENTRY)
#define MIB_SBWC_MOD                    ((WLAN_SBWC_ID+4)|MIB_DEL_TBL_ENTRY|MIB_MOD_TBL_ENTRY)
#define MIB_SBWC_DELALL                 ((WLAN_SBWC_ID+5)|MIB_DELALL_TBL_ENTRY)

#define MIB_SBWC_STA_MAC				(WLAN_SBWC_ID+6)
#define MIB_SBWC_STA_TX_LIMIT           (WLAN_SBWC_ID+7)
#define MIB_SBWC_STA_RX_LIMIT           (WLAN_SBWC_ID+8)
#endif

#ifdef TIMER_TASK_SUPPORT
#define WLAN_TIMER_TASK_ID                          2630
#define MIB_TIMER_TASK_NUM                    (WLAN_TIMER_TASK_ID+0)
#define MIB_TIMER_TASK_TBL                    ((WLAN_TIMER_TASK_ID+1)|MIB_TABLE_LIST)
#define MIB_TIMER_TASK_ADD                    ((WLAN_TIMER_TASK_ID+2)|MIB_ADD_TBL_ENTRY)
#define MIB_TIMER_TASK_DEL                    ((WLAN_TIMER_TASK_ID+3)|MIB_DEL_TBL_ENTRY)
#define MIB_TIMER_TASK_MOD                    ((WLAN_TIMER_TASK_ID+3)|MIB_DEL_TBL_ENTRY|MIB_MOD_TBL_ENTRY)
#define MIB_TIMER_TASK_DELALL                 ((WLAN_TIMER_TASK_ID+4)|MIB_DELALL_TBL_ENTRY)

#define MIB_TIMER_TASK_ID				(WLAN_TIMER_TASK_ID+5)
#define MIB_TIMER_TASK_TIMER_OFFSET           (WLAN_TIMER_TASK_ID+6)
#define MIB_TIMER_TASK_WEEK           (WLAN_TIMER_TASK_ID+7)
#define MIB_TIMER_TASK_ENABLE           (WLAN_TIMER_TASK_ID+8)
#define MIB_TIMER_TASK_ACTION           (WLAN_TIMER_TASK_ID+9)
#define MIB_TIMER_TASK_TIMER_OFFSET2           (WLAN_TIMER_TASK_ID+10)
#define MIB_TIMER_TASK_INDEX           (WLAN_TIMER_TASK_ID+11)
#endif

#if defined(CONFIG_ANDLINK_SUPPORT)
#define RTL_LINK_AREA_TBL_ID				  	 	 2650
#define MIB_RTL_LINK_AREA_TBL_NUM                    (RTL_LINK_AREA_TBL_ID+0)
#define MIB_RTL_LINK_AREA_TBL                    	 ((RTL_LINK_AREA_TBL_ID+1)|MIB_TABLE_LIST)
#define MIB_RTL_LINK_AREA_TBL_ADD                    ((RTL_LINK_AREA_TBL_ID+2)|MIB_ADD_TBL_ENTRY)
#define MIB_RTL_LINK_AREA_TBL_DEL                    ((RTL_LINK_AREA_TBL_ID+3)|MIB_DEL_TBL_ENTRY)
#define MIB_RTL_LINK_AREA_TBL_MOD                    ((RTL_LINK_AREA_TBL_ID+3)|MIB_DEL_TBL_ENTRY|MIB_MOD_TBL_ENTRY)
#define MIB_RTL_LINK_AREA_TBL_DELALL                 ((RTL_LINK_AREA_TBL_ID+4)|MIB_DELALL_TBL_ENTRY)

#define	MIB_RTL_LINK_AREA_CODE						 (RTL_LINK_AREA_TBL_ID+5)
#define	MIB_RTL_LINK_AREA_IP_DOMAIN					 (RTL_LINK_AREA_TBL_ID+6)
#define	MIB_RTL_LINK_AREA_PORT						 (RTL_LINK_AREA_TBL_ID+7)
#endif
...
#define MIB_CAPWAP_MODE			2360
	typedef enum {
		...
		CAPWAP_UI_CONFIGURED = (1<<4),
		CAPWAP_FW_UPGRADED = (1<<5),
...
#define MIB_MULTIPLE_WAN_BASE  		6000	/*basic value for multiple wan*/
...
#ifdef CONFIG_CMCC
#define	MIB_WLAN_MANUAL_PRIORITY     7008
#define	MIB_WLAN_QOS_ENHANCE		 7009
#define MIB_SSID_VER				 7010
#define MIB_REPEATER_CONNECT		 7012
#endif

#define	MIB_WLAN_PREFER_BSSID		 7012
#define MIB_DEF_GW_MAC				 7013
...
#define SIOCGIWRTLSTAEXTRAINFO      0x8B40  //get extra station table information(client-host-ip, client-host-name)
...
#endif // VPN_SUPPORT
typedef enum { PROTO_BOTH=3, PROTO_TCP=1, PROTO_UDP=2, PROTO_ICMP=4,PROTO_ARP=5, PROTO_ICMP_ARP=6} PROTO_TYPE_T;
...
#undef MIBDEF
}__PACK__ WLAN_SBWC_ENTRY_T, *WLAN_SBWC_ENTRY_Tp;
#endif
...
#undef MIBDEF
}__PACK__ WLAN_TIMER_TASK_ENTRY_T, *WLAN_TIMER_TASK_ENTRY_Tp;
#endif
...
#undef MIBDEF
}__PACK__ RTL_LINK_AREA_ENTRY_T, *RTL_LINK_AREA_ENTRY_Tp;
#endif
...
#endif
#ifdef TIMER_TASK_SUPPORT
        WLAN_TIMERTASK_ARRAY_T,
#endif
#ifdef CONFIG_ANDLINK_SUPPORT
		RTL_LINK_AREA_ARRAY_T,
#endif
#ifdef CONFIG_APP_TR069
#if defined(WLAN_SUPPORT)
...
#define CMCC_SSID_PREFIX_SINGLE_BAND "CMCC-"		//"CMCC-"
#define CMCC_SSID_PREFIX_GW_2G		"CMCC-2.4G-"	//"CMCC-2.4G-"
#define CMCC_SSID_PREFIX_GW_5G		"CMCC-5G-"		//"CMCC-5G-"
#define	CMCC_GUEST_SUFFIX			"-Guest"
#define CMCC_SSID_PREFIX_AP_2G		"CMCC-2.4G-"
#define CMCC_SSID_PREFIX_AP_5G		"CMCC-5G-"
#define CMCC_SSID_RANDOM_CHAR_NUM			4
typedef enum {NOT_UPDATE, UPDATE, HW_SSID_GEN, NO_HW_SSID_GEN} CUST_SET_SSID_T;

#define	CMCC_WLAN_GUEST_IDX			1 // wlan0-va0/wlan1-va0
