...
.cfgright td span{ padding-left:15px; font-size:14px;}
...
function showMACClonelist()
{
	if(<% getdhcpWiredClientnum(); %>==0)
		document.write('<li> 空 </li>');

	for(var i = 0; i< <% getdhcpWiredClientnum(); %>;i++ )
	{ 
	    var clientip = clientListArray[i][0];
		var clientmac = clientListArray[i][1];
		document.write('<li  onclick=\"pick(\''+clientmac+'\',\'macCloneMac\',\'test1\')\" >'+clientip+'</li>');
	}
}
    ...
    <div class="cfg">
        <div class="cfgleft">
            <ul>
				...
				<li class="on"><a href="MACClone.asp">MAC地址克隆</a></li>
