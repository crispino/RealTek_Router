			...
			<div class="swindow">
				<div class="dhcp">
					<div class="sectionstyle">
						...
						<input type="hidden" id="starthidden" name="starthidden" value=""><em>到 <input name="endip1" id="endip1" type="text" size="1" readonly="readonly" style="background-color: #f2f2f1;border: 0;padding-left: 5px;">.</em><b><input name="endip4" type="text"></b><input type="hidden" id="endhidden" name="endhidden" value="">
					</div>
					<div class="sectionstyle">
