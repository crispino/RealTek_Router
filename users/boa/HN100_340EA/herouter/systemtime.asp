...
.cfgright td span{ font-size:14px;}
.cfgright td span2{  font-size:14px; display:-moz-inline-box; display:inline-block; width:100px;}
        ...
        <div class="cfgright">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr id="manNTPServer">
							  ...
							  <td colspan="3"><input class="inp1" size="32" maxlength="64" id="NTPServerIP" name="NTPServerIP" <% getHeInfo("he_ntp_server_get"); %> type="text">
							  </td>
							  <td colspan="3">
