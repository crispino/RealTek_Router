...
.selectinp_custom1{height:28px; border:1px #d2d2d2 solid; width:98px; line-height:26px; font-family:"微软雅黑";color:#666;padding:0 5px; background:#fff url(images/dropd.png) no-repeat right center;}
...
function show5g(){
    if("<%getHeInfo("wlan_interface_num", "wlan2")%>" == 2){
    	$('.cfgleft').css('display','block');
    }
...
<div class="int">
	...
	<div class="cfgleft" style="display: none;">
            <ul>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr id="networkName">
			...
			<td>
			  ...
			  <input class="inp1" type="text" maxlength="27" id="mssid" name="mssid" value="" onkeyup="value=value.replace(/[^\w\.\-\/]/ig,'')"/>
			</td>
