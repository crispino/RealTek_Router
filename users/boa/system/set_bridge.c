...
char lanip[64]={0},lanip_1[64]={0},lanip_2[64]={0},lanip_mask[64]={0},cmd[64]={0};			
...
//		}
	...
	if(opmode != GATEWAY_MODE)
	{
		...
		sprintf(cmd,"sleep 5;ifconfig br0:1 %s netmask 255.255.255.0 broadcast %s up&",lanip_1,lanip_mask);
		system(cmd);
	}
#endif
#ifdef CONFIG_8021Q_VLAN_SUPPORTED
...
#endif
	if(access(IGMPPROXY_PID_FILE,0) == 0)
		{
