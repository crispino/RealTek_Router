...
asp_name_t root_asp[] = {
	...
	{"ShareFolderList",ShareFolderLisheUiOpModet},
	...
	{"getHeInfo",getHeInfo},
	{"dhcpWiredClientList",dhcpWiredClientList},
	{"dhcpMacCloneClientList",dhcpMacCloneClientList},
	{"dhcpWirelessClientList",dhcpWirelessClientList},
	{"draw_wlSiteSurveyTbl", draw_wlSiteSurveyTbl},
#endif
	{NULL, NULL}
};
...
form_name_t root_form[] = {
	...
	{"frmWanIpv6Setup", frmWanIpv6Setup},
	{"frmLanIpv6Setup", frmLanIpv6Setup},
	
#ifdef CONFIG_DSLITE_SUPPORT
	{"frmIpv6DsliteSetup", frmIpv6DsliteSetup},
#endif
	...
	{"doInitInternet",doInitInternet},
	{"heUiReboot",heUiReboot},
	{"heUIUpload",heUIUpload},
	{"dhcpbanding",dhcpbanding},
	{"MACCloneCfg",MACCloneCfg},
	{"setWan",setWan},
	{"entconfig",entconfig},
	{"LoadDefaultSettings",LoadDefaultSettings},
	{"setSysAdm",setSysAdm},
	{"hertsyslog", he_form_syslog},
	{"setSysTime", he_setSysTime},
	{"formwanconfig", formwanconfig},
	{"wirelessSet", he_form_wirelessSet},
	{"wirelessQuick", he_form_wirelessQuick},
	{"wirelessGetMAClist",he_wirelessGetMAClist},
	{"wireless_guest", he_form_wireless_guest},
	{"wps_setting", he_form_wps_setting},
	{"wps_config", he_form_wps_config},
	{"APSecurity",he_APSecurity},
	{"APBatchDeleteAccessPolicyList",he_APBatchDeleteAccessPolicyList},
	{"wireless_channel", he_form_wireless_channel},
	{"disconnectbymacfilter", disconnectbymacfilter},
	{"heUiOpMode",heUiOpMode},
	{"heUiAutoUpload",heUiAutoUpload},
	{"heUIIpfilter",heUIIpfilter},
	{"heUIURLfilter",heUIURLfilter},
	{"heUIMACfilter",heUIMACfilter},
	{"heUIformALGOnOff",heUIformALGOnOff},
	{"heUITelnetd", heUITelnetd},
#endif
#ifdef CONFIG_APP_CMCC_GW_UI
	{"formFastConf",formFastConf},
	{"formReboot", formReboot},
	{"formTracert",formTracert},
	{"formPing",formPing},
#endif
#ifdef CONFIG_ANDLINK_SUPPORT
	{"formAndlink",formAndlink},
#endif
	{NULL, NULL}
};
...
//for allow save config multi-times 
	if(strcmp(form,"formSaveConfig")==0)
		return;
#ifdef CONFIG_APP_BOA_HE_UI	
	if(strcmp(form,"hertsyslog")==0)
		return;
	if(strcmp(form,"wirelessGetMAClist")==0)
		return;
	if(strcmp(form,"MACCloneCfg")==0)
		return;
#endif
#ifdef SYS_DIAGNOSTIC
...
#endif
#ifdef CONFIG_APP_BOA_HE_UI
				if(strcmp(now_form->name,"heUiReboot")==0)
				{
					log_boaform(now_form->name,req);	
				}
#endif
