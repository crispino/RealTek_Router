...
int ShowACSCertCPE(request *wp)
{
	...
	nBytesSent += req_format_write(wp, ("      <td width=\"30%%\"><font size=2><b><script>dw(tr069_ACS_certificat)</script></b></td>\n"));
...
int ShowMNGCertTable(request *wp)
{
	...
	nBytesSent += req_format_write(wp, ("\n"
		...
		"  <tr>\n"
		"      <td width=\"30%%\"><font size=2><b><script>dw(tr069_certificat)</script></b></td>\n"
		"      <td width=\"70%%\"><b></b></td>\n"
		"  </tr>\n"
		"\n"));
...
//usually do not need to upload CPE cert file
	...
	nBytesSent += req_format_write(wp, ("\n"
		"  <tr>\n"
		"      <td width=\"30%%\"><font size=2><b><script>dw(tr069_CA_certificat)</script></b></td>\n"
		"      <td width=\"70%%\"><font size=2>\n"
		...
		"			<script>document.ca_cert.load.value = tr069_upload;</script>\n"
		"           </form>\n"
		"      </td>\n"
		"  </tr>\n"
		"\n"));
...
int ShowAuthSelect(request *wp)
{
	...
	nBytesSent += req_format_write(wp, ("  <tr>\n"));
	nBytesSent += req_format_write(wp, ("      <td width=\"30%%\"><font size=2><b><script>dw(tr069_authentication)</script></b></td>\n"));
	nBytesSent += req_format_write(wp, ("      <td width=\"70%%\"><font size=2>\n"));
	nBytesSent += req_format_write(wp, ("      <input type=\"radio\" name=disconreqauth value=1 %s onClick=\"return authSel()\"><script>dw(tr069_disable)</script>&nbsp;&nbsp;\n"), isDisable==1?"checked":"" );
	nBytesSent += req_format_write(wp, ("      <input type=\"radio\" name=disconreqauth value=0 %s onClick=\"return authSel()\"><script>dw(tr069_enable)</script>\n"), isDisable==0?"checked":"" );
	nBytesSent += req_format_write(wp, ("      </td>\n"));
	nBytesSent += req_format_write(wp, ("  </tr>\n"));
