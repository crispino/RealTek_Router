...
#define ETH_LINK_STATUS_FILE "/var/tmp/eth_link_status"
...
typedef struct _sitesurvey_status_dual {
    unsigned char number;
    unsigned char pad[3];
    BssDscr bssdb[MAX_BSS_DESC*2];
} SS_STATUS_DUAL_T, *SS_STATUS_DUAL_Tp;
