        ...
        <div class="cfgright">
          <table width="70%" border="0" cellspacing="0" cellpadding="0">
            	<tr>
            		...
            		<td width="5%">&nbsp;</td>
            		<td width="55%">
            			<input class="radiobox" type="radio" name="conTp_radio" id="conTp_radio" onClick="switch_conType()"  value="0">自动获取（DHCP）<br>
            			<br><div style="display:none">
            			<input class="radiobox" type="radio" name="conTp_radio" id="conTp_radio" onClick="switch_conType()"  value="1">静态方式（静态IP）<br>
            			</div>
            			<input class="radiobox" type="radio" name="conTp_radio" id="conTp_radio" onClick="switch_conType()"  value="2">宽带账号（PPPoE）
            		</td><br><br>	
            	</tr>	
              <!--tr>
                <td width="35%" >
