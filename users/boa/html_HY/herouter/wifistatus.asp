...
<div class="int">
<h1 align="center">(第一步)互联网设置—>(第二步)无线设置—><span class="Txttype">(第三步)完成</span></h1>
    <div class="cfg">
				<div class="box">   
					<div class="top">
						<div class="r1"></div>
