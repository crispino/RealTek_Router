    ...
    <div class="cfg">
        ...
        <div class="cfgleft">
            <ul>
				...
				<li class="on"><a href="wireless_wps.asp">2.4GWPS设置</a></li>
		...
		<div style="border-bottom:1px #efefef solid; padding-bottom:15px;padding-bottom:50px;">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" id="wpsconfig">
			<tr>
		  	...
		  	<tr>
				...
				<td width="75%">
					 <span >
						<b style="display:block; cursor:pointer; width:95px;height: 26px;line-height: 26px; font-weight:normal; padding:0 22px;background:#77d1df; font-size:16px; color:#fff; text-align:center;" onclick="wpsConfigSubmit();">开始配置</b>
					</span>
				</td>
			 </tr>
		</table>
