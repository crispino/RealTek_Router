    ...
    <div class="cfg">
        <div class="cfgleft">
            <ul>
				...
				<li class="on"><a class="ifdisabled" href="systemtime.asp">系统时间管理</a></li>
        ...
        <div class="cfgright" style="padding-left: 12px;">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              	<tr id="curtime" style="display: block;">
	                <td width="111">当前系统时间： </td>
	                <td colspan="6"><% getHeInfo("he_system_time_get"); %> </td>
              	</tr>
              	<tr id="manNTPServer">
				  <td width="111"><span2>NTP服务器</span2></td>
				  <td colspan="3"><input class="inp2" size="32" maxlength="64" id="NTPServerIP" name="NTPServerIP" <% getHeInfo("he_ntp_server_get"); %> type="text">
				  </td>
				  <td colspan="3">
				  	&nbsp;&nbsp;<font color="#808080">例：&nbsp;ntp1.aliyun.com</font>
				  </td>
				</tr>
				<tr  id="manNTPSync">
				  <td width="111"><span2>NTP同步(小时)</span2></td>
				  <td colspan="6"><input class="inp2" size="4" id="NTPSync" name="NTPSync" <% getHeInfo("he_ntp_sync_get"); %> type="text"> </td>
				</tr>
              <tr id="sysdate">
                <td width="111">修改系统时间为</td>
                <td colspan="6"><input id="ymd" name="ymd" class="inp2" type="text"></td>
                <td colspan="3">
				  	&nbsp;&nbsp;<font color="#808080">例：1999-01-01</font>
				  </td>
              </tr>
              <tr id="systime">
                <td width="111"></td>
				...
				<input class="selectinp" style="width: 60px;" type="text" id="select1" name="hour" value="0"/></td>
                <td width="6%">时</td>
                <td width="14%">
				...
				<input class="selectinp" style="width: 60px;" type="text" id="select2" name="minute" value="0"/></td>
                <td width="6%">分</td>
                <td width="14%">
				<div class="fix" style=" z-index:999;">
				...
				<input class="selectinp" style="width: 60px;" type="text" id="select3" name="second" value="0"/></td>
                <td width="9%" >秒</td>
              </tr>
            </table>
            <div class="subpart">
