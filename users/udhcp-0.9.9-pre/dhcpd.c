...
void addOption12ToLease(u_int32_t yiaddr, char *hostname)
{
	int bytes;
	struct dhcpOfferedAddr *lease=find_lease_by_yiaddr(yiaddr);
...
#if 1 //defined(CONFIG_RTL8186_KB) || defined(CONFIG_RTL8186_TR) || defined(CONFIG_RTL865X_SC) || defined(CONFIG_RTL865X_AC) || defined(CONFIG_RTL865X_KLD) || defined(CONFIG_RTL8196C_EC)
	char *hostname=NULL;
#endif
#if defined(CONFIG_RTL865X_SC) || defined(CONFIG_RTL8186_TR) || defined(CONFIG_RTL865X_AC) || defined(CONFIG_RTL865X_KLD) || defined(CONFIG_RTL8196C_EC)
	char logbuf[500];
			...
			if (lease) { /*ADDME: or static lease */
				...
				if (server_id) {
					...
					if (server_id_align == server_config.server && requested && 
						...
						addOption12ToLease(lease->yiaddr, hostname);
					}
				} 
				else
				{
						...
						else
						{
							...
							else
							{
								...
								else
								{
									...
									addOption12ToLease(packet.yiaddr, hostname);
								}
							}				
...
#if 0 //defined(CONFIG_RTL8186_KB) || defined(CONFIG_RTL8186_TR) || defined(CONFIG_RTL865X_SC) || defined(CONFIG_RTL865X_AC) || defined(CONFIG_RTL865X_KLD) || defined(CONFIG_RTL8196C_EC)
